...
const Positions = (() => {
  ...
  // For double bass (French system): positions defined by where 1st finger falls
  const POSITION_DATA = [
    {
      id: 'half',
      label: 'Demi-position',
      ...
      description: 'Le 1er doigt sur le demi-ton. Fondation de la technique.',
      fingering: [
        { finger: 1, semitone: 1 },
        { finger: 2, semitone: 2 },
        { finger: 4, semitone: 3 },
      ],
      distanceInfo: 'Environ 2–3 cm depuis le sillet',
    },
    {
      id: 'pos1_1',
      label: '1ère position (1.1)',
      sublabel: '1.1',
      color: '#2980b9',
      firstFingerSemitone: 2,
      description: '1er doigt sur le 2e demi-ton. Position de base pour débutants.',
      fingering: [
        { finger: 1, semitone: 2 },
        { finger: 2, semitone: 3 },
        { finger: 4, semitone: 4 },
      ],
      distanceInfo: '~4–5 cm du sillet (corde Sol)',
    },
    {
      id: 'pos1_2',
      label: '1ère position (1.2)',
      sublabel: '1.2',
      color: '#16a085',
      firstFingerSemitone: 3,
      description: '1er doigt sur le 3e demi-ton. Extension naturelle de la 1.1.',
      fingering: [
        { finger: 1, semitone: 3 },
        { finger: 2, semitone: 4 },
        { finger: 4, semitone: 5 },
    ...
    },
    {
      ...
      description: 'Saut de position. 1er doigt 7 demi-tons au dessus de la corde à vide.',
      fingering: [
        { finger: 1, semitone: 7 },
        { finger: 2, semitone: 8 },
        { finger: 4, semitone: 9 },
      ],
      distanceInfo: '~14–16 cm du sillet',
    },
    {
      id: 'pos4',
      label: '4e position',
      ...
      description: 'Position avancée. Accès aux notes aiguës.',
      fingering: [
        { finger: 1, semitone: 9 },
